...
class CreateAuditTest extends TestCase
{
    ...
    {
        config(['cors.allowed_origins' => ['https://panel.example.com', 'https://seo.example.com']]);
        ...
        $preflight('https://panel.example.com')
            ->assertHeader('Access-Control-Allow-Origin', 'https://panel.example.com');
